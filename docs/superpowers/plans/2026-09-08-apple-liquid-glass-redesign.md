...
- [x] **Step 1: Strengthen the shell discovery assertion**
...
- [x] **Step 3: Refactor shell markup without changing navigation behavior**
...
- [x] **Step 4: Implement shared tokens and shell CSS**
...
- [x] **Step 1: Add minimal presentational hooks**
...
- [x] **Step 2: Implement the accepted desktop composition**
...
- [x] **Step 3: Implement the accepted mobile composition**
...
- [x] **Step 4: Run focused unit and browser workflows**
...
- [x] **Step 1: Add presentational report wrappers**
...
- [x] **Step 2: Match the AwardLens concept**
...
- [x] **Step 3: Apply the report language to Evaluations**
...
- [x] **Step 2: Capture native comparison screenshots**
...
- [x] **Step 3: Complete the fidelity ledger**
...
- [x] **Step 4: Record the replacement video**
